...
function formatDeviceState(state) {
    ...
    const powerState = capabilities.find((cap) => cap.type === "devices.capabilities.on_off" &&
    ...
    const colorTemp = capabilities.find((cap) => cap.type === "devices.capabilities.color_setting" &&
        cap.instance === "colorTemperatureK");
    const color = capabilities.find((cap) => cap.type === "devices.capabilities.color_setting" &&
...
async function saveCurrentStates(deviceStates) {
